import ExpandedKeywordsTable from '../crawler/ExpandedKeywordsTable'
import ExpandedKeywordsLoading from '../crawler/ExpandedKeywordsLoading'

const ExpandedKeywordsSection = ({ expandedLoading, expandedKeywordsData }) => {
  if (expandedLoading) {
    return <ExpandedKeywordsLoading />;
  }

  if (!expandedKeywordsData) return null
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 mt-12 max-w-6xl mx-auto border-t-4 border-teal-500">
      <div className="flex items-center mb-4">
        ...
        <h2 className="text-xl font-semibold text-gray-800">AI-Driven High-Impact Keywords</h2>
      </div>
      <p className="text-gray-600 mb-5 pl-12">Here are the top keywords identified based on search intent, competition, and user behavior. Use these to optimize your content strategy and drive better results.</p>
      <div className="border-t border-gray-100 pt-4">
        <ExpandedKeywordsTable csvData={expandedKeywordsData} />
      </div>
    </div>
  )
}

export default ExpandedKeywordsSection 